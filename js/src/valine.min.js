 ...
 * Last Update: 2019-06-21 16:34:55
 */
! function (e, t) {
    ...
    return function (e) {
      ...
      */
      ...
      ! function () {
        var e = u.create("script", "src", "//cdn.jsdelivr.net/npm/leancloud-storage/dist/av-min.js"),
        ...
        try {
          var n = e.lang,
            ...
            w = e.recordIP,
            _ = e.serverURLs,
            A = void 0 === _ ? "https://avoscloud.com" : _,
            O = e.clazzName,
            S = void 0 === O ? "Comment" : O;
          t.config.clazzName = S;
          var $ = m.ds,
            E = a ? "&q=" + Math.random().toString(32).substring(2) : "";
          if (n && r && t.installLocale(n, r), t.locale = t.locale || g[n || "zh-cn"], t.notify = c || !1, t.verify = d || !1, w) {
            var C = u.create("script", "src", "//api.ip.sb/jsonip?callback=getIP"),
              z = document.getElementsByTagName("script")[0];
            z.parentNode.insertBefore(C, z), window.getIP = function (e) {
              v.ip = e.ip
            }
          }
          m.params = "?d=" + ($.indexOf(i) > -1 ? i : "mp") + "&v=" + o + E, m.hide = "hide" === i, m.cdn = h.test(l) ? l : m.cdn, y = e.path || y;
          var M = Number(x || 10);
          if (e.pageSize = isNaN(M) ? 10 : M < 1 ? 10 : M, s.setOptions({
          ...
          for (var R = u.findAll(document, ".valine-comment-count"), B = 0, j = R.length; B < j; B++) ! function (e, n) {
            var r = R[e];
            if (r) {
          ...
          var I = e.el || null,
            P = u.findAll(document, I);
          if (!(I = I instanceof HTMLElement ? I : P[P.length - 1] || null)) return;
          t.el = I, t.el.classList.add("v"), m.hide && t.el.classList.add("hide-avatar"), e.meta = (e.guest_info || e.meta || b).filter(function (e) {
            return b.indexOf(e) > -1
          });
          var U = (0 == e.meta.length ? b : e.meta).map(function (e) {
            var n = "mail" == e ? "email" : "text";
            return b.indexOf(e) > -1 ? '<input name="' + e + '" placeholder="' + t.locale.head[e] + '" class="v' + e + ' vinput" type="' + n + '">' : ""
          });
          t.placeholder = e.placeholder || "Just Go Go", t.el.innerHTML = '<div class="vwrap"><div class="vheader item' + U.length + '">' + U.join("") + '</div><div class="vedit"><textarea id="veditor" class="veditor vinput" placeholder="' + t.placeholder + '"></textarea><div class="vctrl"><span class="vemoji-btn">' + t.locale.ctrl.emoji + '</span> | <span class="vpreview-btn">' + t.locale.ctrl.preview + '</span></div><div class="vemojis" style="display:none;"></div><div class="vinput vpreview" style="display:none;"></div></div><div class="vcontrol"><div class="col col-20" title="Markdown is supported"><a href="https://segmentfault.com/markdown" target="_blank"><svg class="markdown" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M14.85 3H1.15C.52 3 0 3.52 0 4.15v7.69C0 12.48.52 13 1.15 13h13.69c.64 0 1.15-.52 1.15-1.15v-7.7C16 3.52 15.48 3 14.85 3zM9 11H7V8L5.5 9.92 4 8v3H2V5h2l1.5 2L7 5h2v6zm2.99.5L9.5 8H11V5h2v3h1.5l-2.51 3.5z"></path></svg></a></div><div class="col col-80 text-right"><button type="button" title="Cmd|Ctrl+Enter" class="vsubmit vbtn">' + t.locale.ctrl.reply + '</button></div></div><div style="display:none;" class="vmark"></div></div><div class="vinfo" style="display:none;"><div class="vcount col"></div></div><div class="vlist"></div><div class="vempty" style="display:none;"></div><div class="vpage txt-center"></div><div class="info"><div class="power txt-right">Powered By <a href="https://valine.js.org" target="_blank">Valine</a><br>v' + o + "</div></div>";
          var N = u.find(t.el, ".vempty");
          t.nodata = {
            show: function (e) {
              return N.innerHTML = e || t.locale.tips.sofa, u.attr(N, "style", "display:block;"), t
            },
            hide: function () {
              return u.attr(N, "style", "display:none;"), t
            }
          };
          var V = u.create("div", "class", "vloading"),
            Q = u.find(t.el, ".vlist");
          t.loading = {
            show: function (e) {
              var n = u.findAll(Q, ".vcard");
              return e ? Q.insertBefore(V, n[0]) : Q.appendChild(V), t.nodata.hide(), t
            },
            hide: function () {
              var e = u.find(Q, ".vloading");
              return e && u.remove(e), 0 === u.findAll(Q, ".vcard").length && t.nodata.show(), t
            }
          };
          var F = u.find(t.el, ".vmark");
          t.alert = {
            show: function (e) {
              F.innerHTML = '<div class="valert txt-center"><div class="vtext">' + (e && e.text || 1) + '</div><div class="vbtns"></div></div>';
              var n = u.find(F, ".vbtns"),
              ...
              if (n.innerHTML = "" + r + (e && e.type && i), u.on("click", u.find(F, ".vcancel"), function (e) {
                  t.alert.hide()
                }), u.attr(F, "style", "display:block;"), e && e.type) {
                var o = u.find(F, ".vsure");
            ...
            hide: function () {
              return u.attr(F, "style", "display:none;"), t
            }
          }, t.bind(e)
        } catch (e) {
          t.ErrorHandler(e)
      ...
      r.prototype.Q = function (e) {
        ...
        if (1 == arguments.length) {
          ...
          return i.equalTo("url", decodeURI(e)), i.addDescending("createdAt"), i.addDescending("insertedAt"), i
        }
        ...
        var t = this,
          ...
          f = p.data;
        for (var h in f) f.hasOwnProperty(h) && function (e, r) {
          var i = u.create("i", {
            name: e,
            title: e
          });
        ...
        t.emoji = {
          ...
          show: function () {
            return v.comment && (t.emoji.hide(), u.attr(o, "v", 1), u.removeAttr(i, "v"), r.innerHTML = v.comment, u.attr(r, "style", "display:block"), L()), t.preview
          },
          hide: function () {
        ...
        for (var w = e.meta, k = {}, _ = {
            veditor: "comment"
          }, A = 0, O = w.length; A < O; A++) _["v" + w[A]] = w[A];
        for (var S in _) _.hasOwnProperty(S) && function () {
          var e = _[S],
            n = u.find(t.el, "." + S);
          k[e] = n, n && u.on("input change blur", n, function (t) {
        ...
        t.Q(y).count().then(function (e) {
          e > 0 ? (u.attr(u.find(t.el, ".vinfo"), "style", "display:block;"), u.find(t.el, ".vcount").innerHTML = '<span class="vnum">' + e + "</span> " + t.locale.tips.comments, z()) : t.loading.hide()
        }).catch(function (e) {
          t.ErrorHandler(e)
        });
        var M = function (e, n, r) {
          ...
          L = function () {
            setTimeout(function () {
              try {
                var e = e || "";
                e && e.Hub.Queue(["Typeset", e.Hub]), $("pre code").each(function (e, t) {
          ...
          B = function (e, t) {
            u.on("click", e, function (e) {
              ...
              R = {
                ...
                pid: t.id,
                rmail: t.get("mail")
              }, u.attr(k.comment, "placeholder", n), k.comment.focus()
            })
          };
        ! function () {
        ...
        var j = function () {
            v.comment = "", k.comment.value = "", b(k.comment), u.attr(k.comment, "placeholder", t.placeholder), R = {}, t.preview.empty().hide()
          },
          ...
          P = function (e) {
            ...
            }) : "" == v.comment ? void k.comment.focus() : (v.nick = v.nick || "Anonymous", void(t.notify || t.verify ? V(N) : N()))
          },
          U = function () {
            var e = new AV.ACL;
            ...
            return d.each(t, function (t, r) {
              ...
              switch (r.name.toLowerCase()) {
                ...
                case "class":
                  ...
                  if (r.value.indexOf("at") > -1) return d.attr(e, "class", "at"), !1
              }
